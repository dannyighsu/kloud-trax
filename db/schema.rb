...
ActiveRecord::Schema.define(version: 20140808224751) do

  create_table "accounts", force: true do |t|
    t.string   "service"
    t.integer  "accountid",  limit: 255
  ...
  add_index "tracks", ["account_id"], name: "index_tracks_on_account_id"
  add_index "tracks", ["directory_id"], name: "index_tracks_on_directory_id"
